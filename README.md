...
## التقارير والإرسال بالبريد

قسم التقارير في `/dashboard`: توليد **أسبوعي** أو **مخصّص** (مهمة خلفية بشريط تقدّم)، حفظ وأرشفة، وتصدير **PDF / Word / Markdown**.

**الإرسال بالبريد** (`/backup` ← بطاقة البريد الإلكتروني): SMTP مع App Password (إعدادات جاهزة لـ Gmail/Outlook). المتن منسّق RTL مع مرفقَي PDF و Word. مُشغِّلات الإرسال:
- مع التقرير الأسبوعي المجدول
- عند إنشاء أي تقرير (أسبوعي أو مخصّص، من الواجهة أو الدردشة)
- جدول بريد مستقل (أرسل أحدث تقرير أو ولّد جديداً)
- زر «📧 بريد» لكل تقرير

كلمة مرور SMTP تُخزَّن منفصلة (`data/email_secret.json`) ولا تُضمّن إلا في النسخ الاحتياطية **المشفّرة**، ولا يعيدها الـ API أبداً.
